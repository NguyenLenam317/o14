...
} from './weatherUtils'; // Assuming these functions are defined in a separate file
...
// Improved request processing with better error handling
const processRequestHandler = async (
  ...
  try {
    ...
    console.error(`Error processing request: ${typedError.message}`);
    res.status(500).json({ 
      message: 'Internal server error',
      ...(process.env.NODE_ENV === 'development' && { 
...
export async function registerRoutes(app: any): Promise<any> {
  ...
  async function getDeviceIdFromRequest(req: express.Request): Promise<string> {
  ...
  app.get("/api/user/profile", async (req: express.Request, res: express.Response) => {
    try {
  ...
  app.post("/api/user/survey/complete", async (req: express.Request, res: express.Response) => {
    try {
  ...
  app.get("/api/weather/current", async (req: express.Request, res: express.Response) => {
    try {
  ...
  // Get forecast data
  app.get("/api/weather/forecast", async (req: express.Request, res: express.Response) => {
    try {
  ...
  app.get("/api/weather/air-quality/forecast", async (req: express.Request, res: express.Response) => {
    try {
      const airQualityData = await getOpenMeteoAirQuality();
  ...
  app.get("/api/weather/air-quality/historical", async (req: express.Request, res: express.Response) => {
    try {
  ...
  // Get pollen data
  app.get("/api/weather/pollen", async (req: express.Request, res: express.Response) => {
    try {
  ...
  // Get climate data
  app.get("/api/climate/data", async (req: express.Request, res: express.Response) => {
    try {
  ...
  // Get flood risk data
  app.get("/api/climate/flood-risk", async (req: express.Request, res: express.Response) => {
    try {
  ...
  app.get("/api/climate/projections", async (req: express.Request, res: express.Response) => {
    try {
  ...
  app.get("/api/weather/alerts", async (req: express.Request, res: express.Response) => {
    try {
  ...
  app.get("/api/weather/recommendations/activities", async (req: express.Request, res: express.Response) => {
    try {
      // Get current weather and air quality data
      const forecast = await getOpenMeteoForecast();
      const airQuality = await getOpenMeteoAirQuality();
  ...
  app.get("/api/weather/recommendations/clothing", async (req: express.Request, res: express.Response) => {
    try {
      // Get current weather data
      const forecast = await getOpenMeteoForecast();
      const airQuality = await getOpenMeteoAirQuality();
  ...
  app.get("/api/health/recommendations", async (req: express.Request, res: express.Response) => {
    try {
      // Get current weather and air quality data
      const forecast = await getOpenMeteoForecast();
      const airQuality = await getOpenMeteoAirQuality();
  ...
  app.get("/api/activities/time-slots", async (req: express.Request, res: express.Response) => {
    try {
      // Get current weather and air quality data
      const forecast = await getOpenMeteoForecast();
      const airQuality = await getOpenMeteoAirQuality();
  ...
  app.get("/api/activities/outdoor", async (req: express.Request, res: express.Response) => {
    try {
      // Get current weather and air quality data
      const forecast = await getOpenMeteoForecast();
      const airQuality = await getOpenMeteoAirQuality();
  ...
  app.get("/api/activities/indoor", async (req: express.Request, res: express.Response) => {
    try {
      // Get user preferences
      const userId = 0; // Using demo user for now
      const interests = await storage.getInterests(userId);
  ...
  app.get("/api/sustainability/tips", async (req: express.Request, res: express.Response) => {
    try {
  ...
  app.get("/api/sustainability/initiatives", async (req: express.Request, res: express.Response) => {
    try {
  ...
  app.get("/api/sustainability/polls", async (req: express.Request, res: express.Response) => {
    try {
  ...
  // Vote on a poll
  app.post("/api/sustainability/vote", async (req: express.Request, res: express.Response) => {
    try {
  ...
  // Create a new poll
  app.post("/api/sustainability/polls/create", async (req: express.Request, res: express.Response) => {
    try {
  ...
  // Get community ideas
  app.get("/api/sustainability/ideas", async (req: express.Request, res: express.Response) => {
    try {
  ...
  app.post("/api/sustainability/ideas/submit", async (req: express.Request, res: express.Response) => {
    try {
  ...
  // Get chat history
  app.get("/api/chat/history", async (req: express.Request, res: express.Response) => {
    try {
  ...
  app.post("/api/chat/send", async (req: express.Request, res: express.Response) => {
    const deviceId = req.headers['x-device-id'] as string;
...
// Improved type safety for comparison and calculation functions
function compareValues(a: number, b: number): number {
  return a - b;
}
...
// Improved sanitizeCode function
function sanitizeCode(code: string): string {
  // More robust sanitization
  return code
    .replace(/[<>&'"]/g, '') // Remove potentially harmful characters
    .trim()
    .slice(0, 1000); // Limit code length
}
